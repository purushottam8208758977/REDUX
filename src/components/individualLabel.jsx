...
export class IndividualLabel extends Component {
    labelledNotes=()=>{
        console.log("label info-->",this.props.data)
        this.props.labelName(this.props.data.labelName)
    }
    render() {
        return (
            <div ><ListItem id="adjustContent" button key="L" onClick={this.labelledNotes}>
